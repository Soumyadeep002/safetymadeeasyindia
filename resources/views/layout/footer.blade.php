    ...
    <div class="footer-callto-action-area bg-light-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="call-to-sction bg_image shape-move {{ request()->routeIs('books.*', 'books.my', 'user.*') ? 'cta-no-overlap' : '' }}">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="footer-one-main-wrapper">
                        ...
                        <div class="footer-singl-wized left-logo">
                            ...
                            <div class="body">
                                ...
                                <ul class="wrapper-list">
                                    ...
                                    <li><i class="fa-regular fa-phone"></i><a href="tel:+917980884372">+91 79808 84372</a></li>
                                    <li><i class="fa-regular fa-phone"></i><a href="tel:+919874082111">+91 98740 82111</a></li>
                                    <li><i class="fa-regular fa-envelope"></i><a href="mailto:info@safetymadeeasyindia.com">info@safetymadeeasyindia.com</a></li>
                                    <li>GST NUMBER : 19AFHFS5051B1Z3</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="footer-singl-wized">
                            ...
                            <div class="body">
                                <ul class="menu">
                                    <li><a href="{{url('/course-1001')}}">Training One</a></li>
                                    <li><a href="{{url('/course-1020')}}">Training Two</a></li>
                                    <li><a href="{{url('/course-1010')}}">Training Three</a></li>
                                    <li><a href="{{url('/course-1024')}}">Training Four</a></li>
                                    <li><a href="{{url('/course-1028')}}">Training Five</a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- single sized  footer end -->
        ...
        <div class="mobile-menu-main">
            <nav class="nav-main mainmenu-nav mt--30">
                <ul class="mainmenu metismenu" id="mobile-menu-active">
                    ...
                    <li class="has-droupdown">
                        <a href="{{ route('courses') }}" class="main">Training</a>
                    </li>
                    <li class="has-droupdown">
                        <a href="{{url('/books')}}" class="main">Books</a>
                    </li>
                    <li class="has-droupdown">
            ...
            <div class="buttons-area">
                <a href="{{ route('courses') }}" class="rts-btn btn-border">View Trainings</a>
    ...
    <script src="{{url('assets/js/auth-user.js')}}"></script>
    ...
    <script>
      let form = document.querySelector("#contactform");
        form.addEventListener('submit', (e) => {
            ...
            fetch('https://safetymadeeasyindia.com/api/get-messages', {
                    method: "POST",
                    mode: "no-cors",
                    body: data
                })
