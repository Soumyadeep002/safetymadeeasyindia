                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img loading="lazy" style="width: 12rem; max-height: 100px !important; object-fit: cover;" src="{{url('assets/images/brand/08.webp')}}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img loading="lazy" style="width: 12rem; max-height: 100px !important; object-fit: cover;" src="{{url('assets/images/brand/09.webp')}}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img loading="lazy" style="width: 12rem; max-height: 100px !important; object-fit: cover;" src="{{url('assets/images/brand/10.webp')}}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img loading="lazy" style="width: 12rem; max-height: 100px !important; object-fit: cover;" src="{{url('assets/images/brand/11.webp')}}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                ...
                <div class="col-lg-6 pl--90 pl_md--15 mt_md--50 pl_sm--15 pt_sm--50">
                    ...
                    <div class="why-choose-main-wrapper-1">
                        ...
                        <div class="single-choose-reason-1">
                            ...
                            <h6 class="title" style="font-size: 15px !important">Support Community</h6>
                        </div>
                        <!-- single choose reason end -->
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="single-blog-style-one">
                            <a href="{{url('blog'.'/'.$blog->slug)}}" class="thumbnail">
                                <img loading="lazy" src="{{url('/myfile/'.$blog->image1)}}" alt="blog">
                                <div class="tags-area">
                                    <span>{{$blog->category->category_title}}</span>
                                </div>
                            </a>
                            <div class="blog-top-area">
                                <div class="single">
                                    ...
                                    @php
                                        $timestamp = \Carbon\Carbon::parse($blog->created_at);
                                        $diffInWeeks = $timestamp->diffInWeeks(now());
                                    @endphp
                                    {{-- <p>{{ \Carbon\Carbon::parse($blog->created_at)->diffForHumans() }}</p> --}}
                                    @if ($diffInWeeks > 2)
                                        <p>{{ $timestamp->format('d-m-Y') }}</p>
                                    @else
                                        <p>{{ $timestamp->diffForHumans() }}</p>
                                    @endif
                                </div>
                                <div class="single">
                                    <i class="fa-light fa-user"></i>
                                    <p>{{ explode(' ', $blog->author)[0] }}</p>
                                </div>
                            </div>
                            ...
                            <div class="button-area">
                                <a href="{{url('blog'.'/'.$blog->slug)}}" class="rts-btn btn-primary readmore-btn">Read More <i class="fa-regular fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
